...
# Doğrulama
python3 -c "import ollama; import yaml; print('[OK] Tüm Python modülleri yüklü')"
...
if ollama list 2>/dev/null | grep -q "a4v3golden"; then
 ...
 echo " [WARN] Bu PRIVATE bir repo. HF_TOKEN gerekli!"
...
if echo "$GPU_PROC" | grep -q "GPU"; then
 success "Model GPU üzerinde çalışıyor [OK]"
else
...
echo ""
echo " 1⃣ Tüm Ablasyon Sürecini Başlat:"
echo " make ablation"
echo ""
echo " 2⃣ Hızlı Duman Testi (Smoke Test):"
echo " make smoke"
echo ""
echo " Sonuçlar:"
