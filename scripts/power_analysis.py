...
def main():
 ...
 status = '[OK] SUFFICIENT' if 65 >= n_req else '[FAIL] INSUFFICIENT'
 print(f"\n {pair_label} ({desc})")
 ...
 status = '[OK]' if 65 >= math.ceil(n) else '[FAIL]'
 ...
 print(f" {label}: power = {achieved:.3f} ({'≥0.80 [OK]' if achieved >= 0.80 else '<0.80 [WARN]'})")
 ...
 print(" ║ Required n = 8 → n=65 [OK] OVERPOWERED ║")
 print(" ╠══════════════════════════════════════════════════════════╣")
 print(" ║ SECONDARY: Completion Score (V2→V3) ║")
 print(" ║ Cohen's d = 2.602 (Huge Effect) ║")
 print(" ║ Required n = 4 → n=65 [OK] OVERPOWERED ║")
 print(" ╠══════════════════════════════════════════════════════════╣")
 ...
 print()
 print(" [WARN] Caveat: These conservative estimates assume equal variance.")
 print(" [WARN] For small effects (d<0.3), n=65 would be insufficient,")
 print(" [WARN] but the ablation compares fundamentally different datasets")
 print(" [WARN] (raw model vs garbage vs golden), guaranteeing large effects.")
 print("=" * 68)
