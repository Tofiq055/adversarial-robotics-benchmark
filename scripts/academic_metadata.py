...
def main() -> int:
 ...
 print(f" [OK] ENVIRONMENT.md ({(run_dir / 'ENVIRONMENT.md').stat().st_size} bytes)")
 ...
 print(f" [OK] MODEL_METADATA.md ({(run_dir / 'MODEL_METADATA.md').stat().st_size} bytes)")

 print(f"Writing hypotheses & comparison pairs…")
 write_hypotheses_md(args.models, run_dir / "ACADEMIC_HYPOTHESES.md")
 print(f" [OK] ACADEMIC_HYPOTHESES.md ({(run_dir / 'ACADEMIC_HYPOTHESES.md').stat().st_size} bytes)")
